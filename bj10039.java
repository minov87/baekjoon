/*
 * Author Minov (WonSeok, Cho) 12/27/16 5:17 PM
 * 백준 10039 : 평균 점수
 *
 ...
 *
 * 입력 : 입력은 총 5줄로 이루어져 있고, 원섭이의 점수, 세희의 점수, 상근이의 점수,
    ...
    public static void main(String[] args) throws Exception{
        ...
        for(int i=0; i<intScore.length; i++){
            ...
            if(intScore[i] % 5 != 0){
                ...
                intSumScore += intScore[i];
            }
        }

        System.out.println(intSumScore/5);
    }
}
